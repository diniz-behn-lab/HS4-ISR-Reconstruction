...
participant_data = pull_complete_cpep_data("Z:/LEADStudentsTrainees/Ramirez, Daniel/120034/HS4 Project/Derived Datasets/Clean_HS4_Data_For_ISR.xlsx")
...
for (p in partic_range){
  ...
  Mixed_Effect_ISR_results[nrow(Mixed_Effect_ISR_results)+1,] = c(model$partic,model$bmi_cat, model$AUC15, model$AUC30, 
                                                                  ...
                                                                  model$lowbound30AUC, model$upbound30AUC, model$lowbound3hAUC,model$upbound3hAUC, model$mae)
...
write.xlsx(Mixed_Effect_ISR_results,"Z:/LEADStudentsTrainees/Ramirez, Daniel/120034/HS4 Project/Cohort Results/ISR_Derived_Results_HS4.xlsx",
           row.names = FALSE)
write.xlsx(Patient_ISR,"Z:/LEADStudentsTrainees/Ramirez, Daniel/120034/HS4 Project/Cohort Results/Participant_Estimated_ISR_HS4.xlsx",
           row.names = FALSE)

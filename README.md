...
**Note** that C-Peptide data must be in pico moles per liter (pmol/L) for the model to produce accurate results. This script will convert the incoming data from nanograms/milliliter (ng/mL) to the necessary pmol/L. 
